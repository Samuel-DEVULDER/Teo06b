...
static DIALOG file_selector[] =
{
   ...
   { d_shadow_box_proc, 0,    0,    304,  160,  19,    20,    0,    0,       0,    0,    NULL },
   { d_ctext_proc,      152,  8,    1,    1,    19,    20,    0,    0,       0,    0,    NULL },
   { d_button_proc,     208,  107,  80,   16,   19,    20,    0,    D_EXIT,  0,    0,    "OK" },
   { d_button_proc,     208,  129,  80,   16,   19,    20,    27,   D_EXIT,  0,    0,    "Cancel" },
   { fs_edit_proc,      16,   28,   272,  8,    19,    20,    0,    0,       79,   0,    NULL },
   { fs_flist_proc,     16,   46,   176,  99,   19,    20,    0,    D_EXIT,  0,    0,    fs_flist_getter },
   { fs_dlist_proc,     208,  46,   80,   51,   19,    20,    0,    D_EXIT,  0,    0,    fs_dlist_getter },
   { NULL }
};
 ...
 */
int PersoFileSelect(char *message, char *path, char *ext)
{
   int ret;
   char *p;
